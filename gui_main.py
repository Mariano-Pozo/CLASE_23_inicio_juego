...
form_menu_levels = FormMenuLevels(name="form_menu_levels",master_surface = screen,x=400,y=300,w=400,h=300,color_background=None,color_border=None,active=True)
...
form_menu_B = FormMenuSettings(name="form_menu_B",master_surface = screen,x=300,y=200,w=500,h=400,color_background=(0,255,255),color_border=(255,0,255),active=False)
