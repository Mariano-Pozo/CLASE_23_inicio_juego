...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=w,height=h,path=r"images\locations\set_bg_01\forest\all.png")
        ...
        self.trap_list = []
        for Traps in datos_extraidos["niveles"]["nivel_2"]["config_trap"]:
            x,y,w,h= Traps
            self.trap_list.append(Fire(x,y,w,h))

        self.enemy_list = []
        for Enemigos in datos_extraidos["niveles"]["nivel_2"]["config_enemigos"]:
        ...
        self.plataform_list = []
        for Plataforma in datos_extraidos["niveles"]["nivel_2"]["config_plataformas"]:
            x,y,w,h,tipo= Plataforma
            self.plataform_list.append(Plataform(x,y,w,h,tipo))
            
        ##listas coin
        self.coin_list = []
        for Coin in datos_extraidos["niveles"]["nivel_2"]["config_coins"]:
